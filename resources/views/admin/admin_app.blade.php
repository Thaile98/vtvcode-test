...
<head>
    ...
    <!--[if lt IE 9]>
  <script src="{{url('admin/https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js')}}"></script>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="pages/mailbox/mailbox.html"> <i class="fa fa-envelope"></i>  <span>Mailbox</span>
                            <span class="pull-right-container">
